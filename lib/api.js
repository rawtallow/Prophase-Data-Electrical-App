...
// Shown whenever a Subadmin's gated action (see lib/approvals.js) comes back
// as `{ pending: true }` instead of actually taking effect — the record is
// untouched until a Director reviews the request in Approvals.
export const PENDING_APPROVAL_MESSAGE = 'Submitted for director approval — no changes made yet';
