...
export async function GET() {
  ...
  const [clients, assets, quotes, quoteLineItems, jobs, employees, payrollEntries, payrollAllocations, ownerDraws, parts, counters, receipts, complianceRecords, businessSettings, maintenanceContracts] = await Promise.all([
  ...
  const dump = {
    ...
    clients, assets, quotes, quoteLineItems, jobs, employees, payrollEntries, payrollAllocations, ownerDraws, parts, counters, receipts, complianceRecords, businessSettings, maintenanceContracts
  };
